...
The current release is `release_2_1_1`.
...
### Release 2.0
These settings apply only when `--tag=release_2_1_1` is specified on the command line.

``` yaml $(tag) == 'release_2_0'
input-file:
  - preview/v2.1.1/FormRecognizer.json
```
...
input-file:
  - $(this-folder)/preview/v2.1.1/FormRecognizer.json

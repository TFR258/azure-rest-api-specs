...
The current release is `release_2_1_preview1`.

``` yaml

tag: release_2_1_preview1
...
### Release 2.0
These settings apply only when `--tag=release_2_1_preview1` is specified on the command line.
